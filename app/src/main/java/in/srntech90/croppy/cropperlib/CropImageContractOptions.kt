...
import `in`.srntech90.croppy.cropperlib.CropImageOptions.Companion.DEGREES_360
import `in`.srntech90.croppy.cropperlib.CropImageView.*
...
data class CropImageContractOptions @JvmOverloads constructor(
     ...
     * Default: RECTANGLE
     */
    fun setCropCornerShape(cornerShape: CropCornerShape): CropImageContractOptions {
     ...
     * *Default: FIT_CENTER*
     */
    fun setScaleType(scaleType: ScaleType): CropImageContractOptions {
