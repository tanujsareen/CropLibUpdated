...
import `in`.srntech90.croppy.cropperlib.CropImageView.CropShape.OVAL
import `in`.srntech90.croppy.cropperlib.CropImageView.CropShape.RECTANGLE
import `in`.srntech90.croppy.cropperlib.CropImageView.CropShape.RECTANGLE_HORIZONTAL_ONLY
import `in`.srntech90.croppy.cropperlib.CropImageView.CropShape.RECTANGLE_VERTICAL_ONLY
